...
<?php $__env->startSection('scripts'); ?>
	...
	<script src="<?php echo e(asset('/js/js/fileinput.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('/js/js/fileinput_locale_es.js')); ?>" type="text/javascript"></script>
	<script src="<?php echo e(asset('/js/js/fileinput_locale_es.js')); ?>" type="text/javascript"></script>
<!--     <script src="<?php echo e(asset('bootstrap/js/bootstrap.min.js')); ?>"></script> -->
    ...
    <script src="<?php echo e(asset('/startbootstrap-admin/bower_components/metisMenu/dist/metisMenu.min.js')); ?>"></script>
	 <script src="<?php echo e(asset('/startbootstrap-admin/bower_components/morrisjs/morris.min.js')); ?>"></script>
    <script src="<?php echo e(asset('/startbootstrap-admin/js/morris-data.js')); ?>"></script>
    <!-- Morris Charts JavaScript -->
    <script src="<?php echo e(asset('/startbootstrap-admin/bower_components/raphael/raphael-min.js')); ?>"></script>
