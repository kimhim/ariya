...
CREATE TABLE `tbl_product` (
  ...
  `pro_title_en` varchar(250) CHARACTER SET utf8 DEFAULT NULL COMMENT 'title in english language',
  `pro_title_kh` varchar(250) CHARACTER SET utf8 DEFAULT NULL COMMENT 'title in khmer language',
  `pro_unit_price` float(4,2) DEFAULT NULL COMMENT 'Price per item',
  ...
  `pro_description` text CHARACTER SET utf8,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  PRIMARY KEY (`pro_id`)
...
insert  into `tbl_product`(`pro_id`,`pro_title_en`,`pro_title_kh`,`pro_unit_price`,`pro_discount`,`pro_cat`,`pro_color`,`pro_number`,`pro_user_target`,`pro_description`,`created_at`,`updated_at`) values (1,'Iphone 6s Plus','???',220.25,10,1,1,10,2,'test','2016-09-07 17:24:50','2016-09-07 17:24:52');
