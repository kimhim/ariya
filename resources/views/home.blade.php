@extends('layouts.frontend') @section('title') Welcome to our shop
		...
		<!--<div class="row">
				...
				<div class="carousel slide" id="homepage_slideshow">
					...
					<!--<div class="carousel-inner">
						<div class="active item" data-slide-number="0">
							<img src="{{asset('photo/banner/banner_01.png')}}">
						</div>

						<div class="item" data-slide-number="1">
							<img src="{{asset('photo/banner/banner_02.jpeg')}}">
						</div>

						<div class="item" data-slide-number="2">
							<img src="{{asset('photo/banner/banner_03.jpg')}}">
						</div>

						<div class="item" data-slide-number="3">
							<img src="{{asset('photo/banner/banner_04.jpg')}}">
						</div>

						<div class="item" data-slide-number="4">
							<img src="{{asset('photo/banner/banner_05.jpg')}}">
						</div>

						<div class="item" data-slide-number="5">
							<img src="{{asset('photo/banner/banner_06.jpg')}}">
						</div>
					</div>
					<!-- Carousel nav -->
			...
			<div id="slide-content" style="display: none;">
				<div id="slide-content-0">
					...
					<p class="sub-text">
						October 24 2014 - <a href="{{route('detail')}}">Read more</a>
					</p>
				</div>
...
<div id="carousel-example-generic" class="carousel slide">
	...
	<div class="carousel-inner" role="listbox">
		<div class="item active">
			<img src="{{asset('photo/banner/unnamed-24.jpg')}}" alt="...">
		</div>
		<div class="item">
			<img src="{{asset('photo/banner/imgpsh_fullsize-1-825x344.jpg')}}" alt="...">
		</div>
		<div class="item">
			<img src="{{asset('photo/banner/8171706_orig-825x344.jpg')}}" alt="...">
		</div>
	</div>
