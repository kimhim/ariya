...
class HomeController extends Controller
{
    ...
    public function autocomplete(){
		$results = DB::select( DB::raw("SELECT title FROM product"));
		$data = array();
